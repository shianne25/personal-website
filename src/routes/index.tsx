                ...
                <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mb-12">
                            <a href="https://www.linkedin.com/in/shianne-liang-696663254/" className="w-16 h-16 rounded-full bg-pink-200 flex items-center justify-center hover:bg-pink-300 transition-colors">
                            ...
                            <a href="https://github.com/shianne25" className="w-16 h-16 rounded-full bg-pink-200 flex items-center justify-center hover:bg-pink-300 transition-colors">
                                <svg className="w-8 h-8 text-rose-800" fill="currentColor" viewBox="0 0 24 24">
