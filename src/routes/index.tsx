                ...
                <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mb-12">
                            <a href="https://linkedin.com" className="w-16 h-16 rounded-full bg-pink-200 flex items-center justify-center hover:bg-pink-300 transition-colors">
                            ...
                            <a href="mailto:your@email.com" className="w-16 h-16 rounded-full bg-pink-200 flex items-center justify-center hover:bg-pink-300 transition-colors">
                                <svg className="w-8 h-8 text-rose-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                            </a>
                            <a href="https://github.com" className="w-16 h-16 rounded-full bg-pink-200 flex items-center justify-center hover:bg-pink-300 transition-colors">
                                <svg className="w-8 h-8 text-rose-800" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="bg-white/50 backdrop-blur-sm rounded-2xl border border-pink-200 p-6 text-center">
                                <div className="text-4xl font-light text-rose-800 mb-2">5+</div>
                                <div className="text-rose-700">Years</div>
                            </div>
                            <div className="bg-white/50 backdrop-blur-sm rounded-2xl border border-pink-200 p-6 text-center">
                                <div className="text-4xl font-light text-rose-800 mb-2">20+</div>
                                <div className="text-rose-700">Clients</div>
                            </div>
                        </div>
                    </div>
                </div>
